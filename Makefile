...
proto:
	...
	$(PROTOC) \
		$(PROTO_INCLUDES) \
		--go_out=plugins=grpc,$(PROTO_GOGO_MAPPINGS):$(PWD)/proto-gen/api_v2 \
	...
	$(PROTOC) \
		...
		--go_out=plugins=grpc,$(PROTO_GOGO_MAPPINGS):$(PWD)/proto-gen/storage_v1 \
	...
	$(PROTOC) \
		-Iidl/proto \
		--go_out=plugins=grpc,$(PROTO_GOGO_MAPPINGS):$(PWD)/proto-gen/zipkin \
